...
namespace RTLTMPro
{
    ...
    public class RTLTextMeshProEditor : TMP_BaseEditorPanel
    {
        ...
        protected virtual void ListenForZeroWidthNoJoiner()
        {
            ...
            if (editor != null && !string.IsNullOrEmpty(originalTextProp.stringValue))
            {
                try
                {
        ...
        // ---------------------------------------------------------
        // الدوال الجديدة المطلوبة لإصلاح الأخطاء (CS0534)
        // ---------------------------------------------------------

        // دالة لمعرفة إذا كنا نعدل عدة كائنات بأنواع مختلفة (نرجع false دائماً لتبسيط الأمر)
        protected override bool IsMixSelectionTypes()
        {
            return false;
        }

        // دالة لرسم إعدادات إضافية (نتركها فارغة لأننا رسمنا إعداداتنا فوق)
        protected override void DrawExtraSettings()
        {
            // لا شيء هنا
        }

        // دالة التراجع والإعادة (نتركها فارغة حالياً)
